...
#### Jenkins er New Item click koro--->Enter an item name: nextjs-aws --->Select: Pipeline --->click: OK--->Triggers er select koro: GitHub hook trigger for GITScm polling ? --->Pipeline er Definition e select koro: Pipeline script from SCM ---> SCM e select koro: Git --->
